...
submodule_name = '_codepickle_testpkg.mod.dynamic_submodule'
dynamic_submodule = types.ModuleType(submodule_name)

# This line allows the dynamic_module to be imported using either one of:
# - ``from _codepickle_testpkg.mod import dynamic_submodule``
# - ``import _codepickle_testpkg.mod.dynamic_submodule``
...
submodule_name_two = '_codepickle_testpkg.mod.dynamic_submodule_two'
...
submodule_three = types.ModuleType(
    '_codepickle_testpkg.mod.dynamic_submodule_three'
)
code = """
def f(x):
    return x
...
# importable module?
subsubmodule_name = (
    '_codepickle_testpkg.mod.dynamic_submodule.dynamic_subsubmodule'
)
