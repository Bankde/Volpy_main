# Local-main worker -> Local-main worker
```mermaid
graph TD
    subgraph node1
        ...
        worker_IPC_11 -- 1_SubmitTask --> raylet_IPC_1
        raylet_IPC_1 -- 2_DataRef --> worker_IPC_11
        raylet_IPC_1 -- 1 --> raylet_scheduler_1
        raylet_scheduler_1 -- 2 --> raylet_IPC_1
        raylet_IPC_1 -- 3_RunTask --> worker_IPC_12
        worker_IPC_12 -- 4_response_result --> raylet_IPC_1
